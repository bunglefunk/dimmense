...
package net.mcreator.dimmense.world.dimension;
...
import net.mcreator.dimmense.item.DenduraItem;
...
public class DenduraDimension extends DimmenseModElements.ModElement {
	@ObjectHolder("dimmense:dendura")
	public static final ModDimension dimension = null;
	@ObjectHolder("dimmense:dendura_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public DenduraDimension(DimmenseModElements instance) {
		super(instance, 2);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("dendura"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("dimmense:dendura")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("dimmense:dendura"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("dimmense:dendura"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("dimmense:denduron")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new DenduraItem().setRegistryName("dendura"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("dendura_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = DenduraDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos pos, Direction directionIn) {
				...
				return (this.world.getBlockState(framePos).getBlock() == Blocks.IRON_BLOCK.getDefaultState().getBlock()) ? i : 0;
			}
				...
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (!(this.world.getBlockState(framePos).getBlock() == Blocks.IRON_BLOCK.getDefaultState().getBlock())) {
								break label56;
							}
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "dendura_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutable, Blocks.IRON_BLOCK.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = DenduraDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
